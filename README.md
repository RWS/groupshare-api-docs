...
This the main repository for the Groupshare Public API documentation.

## Can I contribute?

Anyone is welcome to contribute to the public Groupshare API documentation by making a pull request into the master repository.


The documentation is split into the following sections:
- Articles
  - This section hosts a series of usefull article on:
    - how to get started with writing plug-ins for Groupshare
...
- Our documentation automatically fills in the product name and other details so you don't have to make the changes manually if we decide to update the product name. Use the '<var:VariableName>' construct to tell our documentation engine to fill in the info for you. Here are the constructs available at this point:
      ...
      <var:ProductName> - The product name, for example Groupshare
      <var:ProductNameWithEdition> - The official product release name including the edition, for example 'Groupshare 2020'
